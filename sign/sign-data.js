...
const contractAbi = require('../artifacts/contracts/Quixotic.sol/ExchangeV4.json'); // Import the contract ABI of the smart contract
...
const chain = 'mumbai'; // Define the chain for which the data should be generated
const web3 = new Web3(`${process.env.POLYGON_MUMBAI_ALCHEMY}`); // Initiate the web3 object using the Infura project ID

...
contract ExchangeV4 is Ownable, Pausable, ReentrancyGuard {
    ...
    */
    ...
    function _validateDutchAuctionSignature( DutchAuctionOrder memory dutchAuctionOrder,bytes memory signature) internal view returns (bool) {
